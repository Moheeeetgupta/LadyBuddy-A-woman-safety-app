...
public class ChoosenActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if (!sharedpreferences.getBoolean(prevStarted, false)) {
            ...
            textView.setText ("Spy cameras which emit IR rays can simply be detected by using night vision of your phone camera.But these days very high tech spy cameras are present in the market which do not even emit IR rays, so our magnetometer sensor simulation helps you detect those spy cameras very easily..");
            alert.setView(mView);
